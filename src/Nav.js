...
function Nav() {
  return (
    <div className=" md:w-screen w-min-[400px] md:text-gray-400 h-fit md:px-12 px-6 md:py-8 py-4 items-center justify-items-cente grid grid-cols-2 md:text-[16px] text-[10px] text-blue-400 fixed z-50">
